...
- **Developer portal rollout timeline confirmed at Q4 KO (2026-09-21, from Daily/2026-09-21 vault note, synced via vault-kb-drift-check).** EA end of September, internal rollout Oct 2nd week, partner rollout following, GA late October/November. Toni flagged that a long runway is needed for customer and partner transitions. Related: Pull (Kanban) workflow confirmed as the Q4 operating model, and Open API specs GPM accountability is still unresolved (rescheduled to PL 2026-09-29) — see Connectors squad's Integrations Marketplace Status.md for the full Q4 KO context.
