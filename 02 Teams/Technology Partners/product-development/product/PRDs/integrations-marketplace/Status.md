...
- **Gournay Consulting staffing watch, new (2026-09-03).** A developer moved from Gournay Consulting to Lettuce Commerce (another Bynder technology partner) -- an internal move between two partners in the ecosystem, not an industry departure. Worth monitoring for continuity effects on Gournay's active work (Brandfolder Migration Tool/MP-258, Fadel/MP-257, both released this week per the Jira signal below). No specific action yet. *(Source: Toni's vault, 2026-09-03 1:1)*
